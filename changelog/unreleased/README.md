...
- [2026-09-18] DeepSeek, GLM and Kimi clients no longer fall back to `OPENAI_API_KEY`, and the Anthropic clients no longer send `ANTHROPIC_AUTH_TOKEN`. ([details](2026-09-18-env-credential-fallbacks.md))
