...
- [2026-09-16] Gemini text, image and TTS models move to the Interactions API on google-genai / @google/genai 2.x; tool-call turns finish with tool_call and fast_mode requests the priority tier. ([details](2026-09-16-gemini-interactions-api.md), TBD)
