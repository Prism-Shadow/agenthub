> Source: https://ai.google.dev/gemini-api/docs/embeddings (snapshot 2026-09-16)
>
> Java and Go samples removed. Embeddings are served by `models.embedContent`, not by the Interactions API.
